...
class SeoController extends Controller
{
    ...
    public function sitemap(): Response
    {
        ...
        $staticUrls = [
            ...
            ['loc' => route('symptom-test'), 'changefreq' => 'weekly', 'priority' => '0.8', 'lastmod' => $today],
            ['loc' => route('departments.index'), 'changefreq' => 'weekly', 'priority' => '0.6', 'lastmod' => $today],
            ['loc' => route('diseases.index'), 'changefreq' => 'weekly', 'priority' => '0.6', 'lastmod' => $today],
