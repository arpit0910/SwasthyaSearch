    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-light border-0">
                <h5 class="modal-title fw-bold text-dark" id="syncModalLabel"><i class="fa-solid fa-rotate me-2 text-primary"></i>Sync City Blood Banks Directory</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4">
                <!-- Input Form Section -->
                <div id="syncFormSection">
                    <p class="text-muted mb-4">Enter the city name to live-scrape and synchronize verified blood banks, government blood centers, and private blood stock facilities. Existing records will be updated automatically.</p>
                    <form id="syncBloodBanksForm">
                        <div class="mb-4">
                            ...
                            <div class="form-text">The scraper will fetch directly from public blood bank directories for this city.</div>
                        </div>
                ...
                <div id="syncProgressSection" style="display: none;" class="py-3 text-center">
                    <div class="mb-3">
                        ...
                        <p id="syncStatusMessage" class="text-muted fs-7 mb-4">Connecting to blood bank directories...</p>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    const syncForm = document.getElementById('syncBloodBanksForm');
    if (!syncForm) return;
    ...
    syncForm.addEventListener('submit', function (e) {
        ...
        // Start Sync Request
        fetch('{{ route('admin.blood_banks.sync') }}', {
            method: 'POST',
            headers: {
        ...
        const interval = setInterval(() => {
            fetch('{{ route('admin.blood_banks.sync.progress') }}')
            .then(res => res.json())
            .then(data => {
                if (data.progress) {
