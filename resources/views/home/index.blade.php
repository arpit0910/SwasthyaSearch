...
@section('meta_title', $locale === 'hi' ? 'Arogio | Doctor Near Me, 24/7 Hospitals, Blood Banks, Medicine & Ayurvedic Remedies' : 'Arogio | Find Doctors Near Me, 24/7 Hospitals, Blood Banks, Medicines & Health Info')
@section('meta_description', $locale === 'hi' ? 'Arogio पर अपने आस-पास सत्यापित डॉक्टर (Doctor near me), 24/7 आपातकालीन अस्पताल, ब्लड बैंक, स्वास्थ्य लेख, ऑनलाइन लक्षण परीक्षक और दादी-नानी के घरेलू नुस्खे खोजें।' : 'Find verified doctors near me, 24/7 emergency hospitals, blood bank availability, medicine guide, online symptom checker, and traditional Ayurvedic home remedies on Arogio.')
@section('meta_keywords', $locale === 'hi' ? 'Arogio, डॉक्टर मेरे पास, Doctor near me, अस्पताल, Hospitals near me, ब्लड बैंक, Blood bank near me, दादी नानी के नुस्खे, स्वास्थ्य लेख, symptom test, wellness tools, आयुर्वेदिक उपचार' : 'Arogio, Doctor near me, Doctors near me, Hospitals near me, Blood bank near me, Blood banks near me, 24/7 blood bank, emergency hospital, Ayurvedic home remedies, medicine directory, symptom test, wellness tools')
@section('content')
@php
    $homeDesign = [
